		...
		<div id="content" class="col-md-10 col-xs-10 col-sm-10" style="padding-top: 0; margin: 0;">
			...
			<div class="table-responsive"  style="margin-top: 20px;">
				<table class="table_list  table-condensed table-hover table-bordered  table-striped">
					...
					<tbody>
					<c:forEach items="${page.list }" var="dep">
						<tr>
							<td>${dep.id }</td>
							<td>${dep.depName }</td>
							<td>${dep.count }</td>
							...
							<button class="btn btn-primary btn-sm target" data-target="toEmpList?depName=${dep.depName }"> 查看部门人员
							</button>　
					...
					<tfoot>
						<tr >
							<td colspan="5" style="text-align: right;"> 
								<!-- 分页插件 -->
								<itheima:page url="${pageContext.request.contextPath }/toDepList" />
	      					</td>
						</tr>
					</tfoot>
				</table>
