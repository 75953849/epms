...
<body>
	<div class="row">
		...
		<div id="content" class="col-md-10 col-xs-10 col-sm-10" style="padding-top: 0; margin: 0;">
			...
			<div id="personaldiv">
				<form class="form-horizontal" action="changeDep" method="post"
					...
					<fieldset>
						...
						<div class="form-group has-feedback">
							...
							<div class="col-md-4 col-xs-4 col-sm-4">
								<input type="text" name="id" class="form-control" value="${dep.id }"  readonly="readonly">
						...
						<div class="form-group has-feedback">
							...
							<div class="col-md-4 col-xs-4 col-sm-4">
								<input type="text" name="depName" class="form-control" value="${dep.depName }">								
							</div>
						</div> 
						
						
						<div class="form-group has-feedback">
							<label class="control-label col-md-2 col-xs-2 col-sm-2">部门人数:</label>
							<div class="col-md-4 col-xs-4 col-sm-4">
								<input type="text" name="count" class="form-control" value="${dep.count }" readonly="readonly">
							</div>
						</div> 
					</fieldset>
					<fieldset>
						...
						<div class="form-group">
							...
							<div class="col-md-5 col-xs-5 col-sm-5">
								<textarea class="form-control" rows="5" cols="68" name="introduction">${dep.introduction }</textarea>
							</div>
						</div>
					</fieldset>
